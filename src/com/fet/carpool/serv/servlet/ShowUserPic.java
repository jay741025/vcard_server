 ...
 */
@WebServlet("/servlet/test/ShowUserPic")
public class ShowUserPic extends HttpServlet {
	...
	protected void showImage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		File imageFile = new File( request.getServletContext().getRealPath( UploadUserPicFile.UPLOAD_FILEPATH_1 ),
				seq + ".jpg" );
		if( !imageFile.exists() ) {
