 ...
 */
@WebServlet("/servlet/test/UploadUserPicFile")
public class UploadUserPicFile extends HttpServlet {

	private static final long serialVersionUID = 1L;
	
	public static final String UPLOAD_TEMPPATH_1 = "/WEB-INF/user_pic_temp/";
	public static final String UPLOAD_FILEPATH_1 = "/WEB-INF/user_upload/";
	private static final int STANDARD_FILE_SIZE = 100 * 100;
	...
	protected void doPost(HttpServletRequest request,
		...
		upload.setFileSizeMax(200*200*10);
		...
		if( read )
			response.getWriter().print(fileSeq);
		else
...
//		boolean isInMemory = item.isInMemory();
		...
		logger.debug( "Path:"+ request.getServletContext().getRealPath(UPLOAD_FILEPATH_1)+"/"+fileSeqNo + ".jpg");
